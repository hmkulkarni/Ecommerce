    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                User user = new User(userFirstName, userLastName, userEmail, userPassword, userPhone, userAddress, "normal");
                ...
                httpSession.setAttribute("message", "Registration Successful! Now proceed to login");
